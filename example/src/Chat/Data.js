...
const createChatItem = (index) => {
    ...
    return {
        ...
        author,
        message,
        avatarUrl: `https://i.pravatar.cc/100?u=${authors[Math.round(index % authors.length)]}`,
        liked: false,
...
export const getSendedMessage = (text) => {
    const message = {
        key: generateId(),
        type: 'me',
        author: 'Me',
...
export const fetchData = (limit = 100) => {
